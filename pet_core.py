...
SPRITE_GROUPS = {name: _frames(name, spec.frame_count) for name, spec in ANIMATIONS.items()}
FRAME_DELAYS_MS = {name: list(spec.delays_ms) for name, spec in ANIMATIONS.items()}
